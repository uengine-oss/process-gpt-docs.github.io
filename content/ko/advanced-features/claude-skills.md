...
## 3. 주요 활용 시나리오
### 3. 활용 사례 1 :피드백 기반 비즈니스 규칙 재설계 (Rule Refactoring)
...
### 4. 활용 사례 2: 실시간 코딩을 통한 스킬 생성 (Custom Skill Generation)
...
## 5. 안전한 최적화: 임시 버전 (Ephemeral Versions)
